...
#         winter_year_files = self.get_all_files_of_winter_year(winter_year=winter_year)

#         for day in winter_year.iterate_days():
#             logger.info(f"Processing day {day}")
#             day_files = self.get_daily_files(all_winter_year_files=winter_year_files)
#             daily_temporal_composite = create_temporal_composite_meteofrance_single_platform(
...
#             self.export_daily_data(day=day, daily_data=out_dataset)
